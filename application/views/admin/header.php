<html lang="en"> 
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="assets/dlab-html/clean360/xhtml/css/jquery.dataTables.min.css">
                ...
                <div class="row d-flex justify-content-between">
                    ...
                    <div class="topbar-right">
                        <ul class="social-line text-center pull-right">
                            ...
                            <li><a href="<?= base_url('Auth/logout'); ?>"><button class="site-button">Logout</button></a></li>
                    ...
                    <div class="container clearfix bg-primary">
                        ...
                        <div class="header-nav navbar-collapse collapse justify-content-end" id="navbarNavDropdown">
                            <ul class=" nav navbar-nav">
                                <li class="active"> <a href="<?= base_url(); ?>">WebHome</a> </li>
                                <li> <a href="<?= base_url('Dashboard'); ?>">Dashboard</a> </li>
                                <li> <a href="<?= base_url('Staff'); ?>">Our Staff</a> </li>
                                <li> <a href="<?= base_url('Gallery'); ?>">Project Images</a> </li>
                                <li> <a href="<?= base_url('Client'); ?>">Our Clients</a> </li>
